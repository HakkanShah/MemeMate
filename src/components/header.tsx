      ...
      <header className="lg:hidden fixed bottom-4 left-1/2 -translate-x-1/2 z-50 flex items-center justify-center">
        <nav className="relative flex items-center justify-center">
                ...
                <Link
                  ...
                  className={cn(
                    ...
                    isActive
                      ...
                      : "bg-card/90 text-muted-foreground hover:bg-accent/80 hover:text-accent-foreground hover:scale-105",
          ...
          <Button
            ...
            className={cn(
              "relative h-14 w-14 rounded-full comic-border !border-4 !shadow-none z-10 transition-all duration-300 hover:scale-110",
              isOpen && "rotate-45 bg-destructive text-destructive-foreground shadow-lg shadow-destructive/50"
            )}
